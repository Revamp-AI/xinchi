...
export async function startSync(provider,{rescan=false}={}){
 ...
 if(typeof rescan!=='boolean'||(rescan&&provider!=='fireflies'))throw Error('History rescans are available only for Fireflies.');
 ...
 if(rescan)await setSetting('fireflies_page',await firefliesWindow({rescan:true}));
