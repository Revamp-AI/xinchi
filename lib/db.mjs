...
export const exportTables=['sources','source_versions','items','events','settings','jobs','proposals','job_events','sync_runs','review_queue','review_batches',...CONTACT_TABLES];
