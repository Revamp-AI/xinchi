...
export function searchSources(q='',provider='',offset=0){
 ...
 const excerpt=tokens.length?"snippet(source_search,2,'«','»','…',24)":'substr(s.body,1,250)',order=tokens.length?'bm25(source_search),s.occurred_at DESC':'s.occurred_at DESC';
